 ...
 *
 * @author Rod Johnson
 * @version $Id: NestedRuntimeException.java,v 1.1 2011/07/28 01:48:36 wms2 Exp $
 */
...
public abstract class NestedRuntimeException extends RuntimeException {
	...
	/**
	 * Construct a <code>NestedRuntimeException</code> with a exception
    ...
    /**
     * Construct a <code>NestedRuntimeException</code> with the specified detail message and
     * nested exception.
     * @param msg the detail message
